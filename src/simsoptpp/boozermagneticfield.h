...
* See Paul. et al, JPP (2023;89(5):905890515. doi:10.1017/S0022377823001095) and refs. therein.
*
* The Shear Alfvén Wave (SAW) propagating in equilibrium field B0 is represented by scalar potential `Phi` and
* vector potential parameter alpha, s.t. the SAW magnetic field is represented by the curl of (alpha*B0).
*
* This class provides a framework for representing SAW in Boozer coordinates, with attributes for
* computing scalar & vector potential and their derivatives: `Phi`, `dPhidpsi`, `Phidot`, etc.
*
* It is designed to be a base class that can be extended to implement specific behaviors.
*
...
protected:
  ...
  *
  * This method should be overridden by derived classes to provide the specific implementation
  * for computing the Phi tensor.
  *
  ...
  */
  ...
  /**
  * @brief Virtual method to compute the partial derivative of scalar potential `Phi` w.r.t. toroidal flux coordinate `psi` .
  *
  * This method should be overridden by derived classes to provide the specific implementation
  * for computing the dPhidpsi tensor.
  *
  ...
  */
  ...
  /**
  * @brief Virtual method to compute the partial derivative of scalar potential `Phi` w.r.t. poloidal Boozer angle `theta`.
  *
  * This method should be overridden by derived classes to provide the specific implementation
  * for computing the dPhidtheta tensor.
  *
  ...
  */
  ...
  /**
  * @brief Virtual method to compute the partial derivative of scalar potential `Phi` w.r.t. toroidal Boozer angle `zeta`.
  *
  * This method should be overridden by derived classes to provide the specific implementation
  * for computing the dPhidzeta tensor.
  *
  ...
  */
  ...
  /**
  * @brief Virtual method to compute the partial derivative of scalar potential `Phi` w.r.t. time.
  *
  * This method should be overridden by derived classes to provide the specific implementation
  * for computing the Phidot tensor.
  *
  ...
  *
  * This method should be overridden by derived classes to provide the specific implementation
  * for computing the alpha tensor.
  *
  ...
  */
  ...
  /**
  * @brief Virtual method to compute the partial derivative of the vector potential parameter `alpha` w.r.t. toroidal flux `psi`
  *
  * This method should be overridden by derived classes to provide the specific implementation
  * for computing the dalphadpsi tensor.
  *
  ...
  */
  ...
  /**
  * @brief Virtual method to compute the partial derivative of the vector potential parameter `alpha` w.r.t. poloidal Boozer angle `theta`
  *
  * This method should be overridden by derived classes to provide the specific implementation
  * for computing the alphadot tensor.
  *
  ...
  */
  ...
  /**
  * @brief Virtual method to compute the partial derivative of the vector potential parameter `alpha` w.r.t. toroidal Boozer angle `zeta`
  *
  * This method should be overridden by derived classes to provide the specific implementation
  * for computing the dalphadzeta tensor.
  *
  ...
  */
  ...
  /**
  * @brief Virtual method to compute the partial derivative of the vector potential parameter `alpha` w.r.t. time
  *
  * This method should be overridden by derived classes to provide the specific implementation
  * for computing the alphadot tensor.
  *
...
public:
  ...
  *
  * @param p A tensor representing the points in Boozer coordinates and time (s, theta, zeta, time).
...
/**
* @brief Class representing the profile of scalar potential with respect to normalized flux Boozer coordinate `s`.
*
* The `Phihat` class represents scalar potential profile (`Phihat`)
* as a function of the normalized toroidal Boozer coordinate `s`. It uses linear interpolation to compute the value
* of the scalar potential and its derivative at any given point within the domain.
*/
class Phihat {
private:
  ...
  /**
  * @brief Validates the input vectors of normalized flux Boozer coordinate `s` and corresponding scalar potential `Phi` values.
  *
  * Ensures that `s_values` and `Phihat_values` have the same size and that all `s_values` are unique.
  *
  * @throws std::invalid_argument if the input vectors are not of the same size or if `s_values` contains duplicates.
  */
  ...
  *
  * Sorts both `s_values` and `Phihat_values` in ascending order of `s_values` to ensure correct interpolation.
  */
  void sortData() {
    std::vector<size_t> indices(s_values.size()); // Create a vector of indices sorted based on s_values
    std::iota(indices.begin(), indices.end(), 0); // Generates a sequence [0, 1, 2, ..., n-1]

    // Sort indices based on the values of s_values:
...
public:
  ...
  *
  * Initializes the `Phihat` object with vectors of `s` coordinates and their corresponding `Phihat` values.
  * Validates the inputs and sorts them by `s` values for proper interpolation.
  *
  ...
  */
  ...
  /**
  * @brief Interpolates the scalar potential `Phihat` at a given `s` coordinate.
  *
  * Computes the value of the scalar potential `Phihat` using linear interpolation between the nearest data points.
  * If `s` is outside the range of `s_values`, returns the nearest boundary value.
  *
  ...
  */
  ...
  /**
  * @brief Computes the derivative of the scalar potential `Phihat` at a given `s` coordinate.
  *
  * Computes the slope of `Phihat` at a given `s` using linear interpolation between the nearest data points.
  ...
  */
  double derivative(double s) const {
    ...
    // Compute slope based on neighboring values
...
public:
  using Tensor2 = T<double, 2, xt::layout_type::row_major>;
  Phihat phihat;  ///< Profile of the scalar potential with respect to Boozer coordinate `s`.
...
protected:
  ...
  /**
  * @brief Computes the scalar potential `Phi` at each point.
  *
  * This method calculates the scalar potential \f$ \Phi \f$ based on the given harmonic parameters
  * and profile \f$ \hat{\Phi}(s) \f$.
  *
  ...
  *
  * This method computes the partial derivative \f$ \frac{\partial \Phi}{\partial \psi} \f$ using the derivative
  ...
  */
  ...
  /**
  * @brief Computes the partial derivative of `Phi` with respect to toroidal angle `zeta`.
  *
  ...
  *
  * This method computes the time derivative \f$ \frac{\partial \Phi}{\partial t} \f$.
  *
  ...
  *
  * This method computes the time derivative \f$ \frac{\partial \alpha}{\partial t} \f$.
  *
  ...
  */
  ...
  /**
  * @brief Computes the partial derivative of `alpha` with respect to toroidal flux coordinate `psi`.
  *
  * This method computes the partial derivative \f$ \frac{\partial \alpha}{\partial \psi} \f$ using the derivative
  * of \f$ \hat{\Phi}(s) \f$ and the harmonic parameters.
  *
  ...
  */
  ...
  /**
  * @brief Computes the partial derivative of `alpha` with respect to poloidal angle `theta`.
  *
...
public:
  using Tensor2 = T<double, 2, xt::layout_type::row_major>;
  std::vector<std::shared_ptr<ShearAlfvenWave<T>>> waves; ///< Vector of waves contributing to the superposition.

  /**
  * @brief Adds a new wave to the superposition after verifying that it has the same equilibrium magnetic fieldn`B0`.
  *
  ...
  *
  * Initializes the superposition with a base wave, setting its `B0` field as the reference field
  ...
  *
  * This method sets the points for the superposition and ensures that all waves in the superposition
  ...
  */
  ShearAlfvenWave<T> &set_points(Tensor2 &p) override {
    ShearAlfvenWave<T>::set_points(p);  // Set points for the base class (ShearAlfvenWave)
    for (const auto &wave : waves) {
      wave->set_points(this->get_points_ref());  // Propagate points to each wave
    }
    return *this;
  }
...
protected:
  ...
  /**
  * @brief Computes the scalar potential `Phi` as the sum of `Phi` of all waves.
  *
  * This method computes the scalar potential `Phi` for the superposition by summing
  * the scalar potential of each wave in the superposition.
  *
  * @param Phi Tensor to be filled with the computed scalar potential values.
  */
  void _Phi_impl(Tensor2 &Phi) override {
  ...
  * @brief Computes the partial derivative of `Phi` with respect to toroidal flux coordinate `psi`.
  *
  * This method computes the partial derivative of `Phi` with respect to `psi` for the superposition
  * by summing the derivatives of each wave in the superposition.
  *
  ...
  * @brief Computes the partial derivative of `Phi` with respect to poloidal angle `theta`.
  *
  * This method computes the partial derivative of `Phi` with respect to `theta` for the superposition
  * by summing the derivatives of each wave in the superposition.
  *
  ...
  * @brief Computes the partial derivative of `Phi` with respect to toroidal angle `zeta`.
  *
  * This method computes the partial derivative of `Phi` with respect to `zeta` for the superposition
  * by summing the derivatives of each wave in the superposition.
  *
  ...
  *
  * This method computes the partial time derivative of `Phi` for the superposition by summing
  * the partial time derivatives of each wave in the superposition.
  *
  * @param Phidot Tensor to be filled with the computed time derivative values.
  */
  void _Phidot_impl(Tensor2 &Phidot) override {
  ...
  /**
  * @brief Computes the vector potential parameter `alpha` as the sum of `alpha` of all waves.
  *
  * This method computes the total vector potential parameter `alpha` for the superposition by summing
  * the `alpha` values of each wave in the superposition.
  *
  * @param alpha Tensor to be filled with the computed vector potential parameter values.
  */
  void _alpha_impl(Tensor2 &alpha) override {
  ...
  /**
  * @brief Computes the partial derivative of `alpha` with respect to toroidal flux `psi`.
  *
  * This method computes the partial derivative of `alpha` with respect to `psi` for the superposition
  * by summing the derivatives of each wave in the superposition.
  *
  ...
  * @brief Computes the partial derivative of `alpha` with respect to poloidal angle `theta`.
  *
  * This method computes the partial derivative of `alpha` with respect to `theta` for the superposition
  * by summing the derivatives of each wave in the superposition.
  *
  ...
  * @brief Computes the partial derivative of `alpha` with respect to toroidal angle `zeta`.
  *
  * This method computes the partial derivative of `alpha` with respect to `zeta` for the superposition
  * by summing the derivatives of each wave in the superposition.
  *
  ...
  *
  * This method computes the partial time derivative of `alpha` for the superposition by summing
  * the time derivatives of `alpha` for each wave in the superposition.
  *
  * @param alphadot Tensor to be filled with the computed time derivative values.
  */
  void _alphadot_impl(Tensor2 &alphadot) override {
